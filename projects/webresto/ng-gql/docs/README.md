...
Ƭ **UserBusEventType**: ``"OTPRequest"`` \| ``"login"`` \| ``"UpdateUserData"`` \| ``"RestorePassword"`` \| ``"AddDishFavor"`` \| ``"captchaGetJob"`` \| ``"registrationApp"`` \| ``"logout"`` \| ``"userDelete"`` \| ``"locationCreate"`` \| ``"locationDelete"`` \| ``"locationSetIsDefault"``
