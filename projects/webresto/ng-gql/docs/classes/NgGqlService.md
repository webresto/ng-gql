...
| `paramOptions?` | [`QueryGenerationParam`](../interfaces/QueryGenerationParam.md)<`VQ`\> | необязательный - Обект настройки генерации части строки запроса с описанием типов параметров операции. |
