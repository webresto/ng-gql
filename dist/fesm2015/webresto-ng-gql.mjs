            ...
            this.apollo.watchQuery({
                ...
                for (let dish of dishes) {
                    ...
                    if (!groupsById[groupId])
                        continue;
                    (_b = groupsById[groupId].dishes) === null || _b === void 0 ? void 0 : _b.push(dish);
                }
                // Create groups hierarchy
                for (let groupId in groupsById) {
                    const group = groupsById[groupId];
                    try {
                        (_c = group.dishes) === null || _c === void 0 ? void 0 : _c.sort((a, b) => { var _a, _b; return ((_a = a.order) !== null && _a !== void 0 ? _a : 0) - ((_b = b.order) !== null && _b !== void 0 ? _b : 0); });
                    }
                    catch (e) {
                        console.warn(`Group ${groupId} sort error`, e);
                    }
                    const parentGroupId = (_d = group.parentGroup) === null || _d === void 0 ? void 0 : _d.id;
...
class NgCartService {
    ...
    getCartId() {
        var _a;
        return (_a = localStorage.getItem(LS_NAME)) !== null && _a !== void 0 ? _a : undefined;
    }
    setCartId(cartId) {
        if (cartId) {
...
class AddDishToCartDirective {
    ...
    addDishToCart(dishID, amount) {
        ...
        let data = {
            ...
            "cartDishId": (_a = this.cart) === null || _a === void 0 ? void 0 : _a.id
        };
